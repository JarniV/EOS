...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net matrix_0_led_out [get_bd_ports led_out_0] [get_bd_pins matrix_0/led_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins matrix_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins matrix_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matrix_0/S00_AXI/S00_AXI_reg] SEG_matrix_0_S00_AXI_reg
